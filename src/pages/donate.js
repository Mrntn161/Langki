        ...
        <main className="subscription-page-wrapper">
          <div className="container">
            <div className="important-notice">
              <p>
                Langki is free for everyone; you don't even need to sign up to use it. No feature is hidden behind a paywall. However, it takes money and time to maintain the server and fulfill each request. Even just a few cents per user each day can accumulate quickly as the user base grows. Therefore, we set a daily usage quota to ensure fair access for all. Langki relies on donations to stay up and running. If you're a heavy user or believe in the potential of the project, please consider donating. With just a cup of coffee a month, you help fund the project to keep it going. In return, you'll gain unlimited access and priority technical support.
              </p>
